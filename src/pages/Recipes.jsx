            ...
            >
              {Array(6)
                ...
                .map((_, index) => (
                  <div
                    key={index}
                    className="bg-gray-200 rounded-3xl neumorphic p-6 animate-pulse"
                  >
                    <div
                      className={`w-full ${
                        viewMode === "grid" ? "h-48" : "h-32"
                      } bg-gray-300 rounded-2xl mb-4`}
                    ></div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {filteredRecipes.map((recipe, index) => (
                  ...
                  >
                    <Link
                      to={createPageUrl(`Recipe?id=${recipe.id}`)}
                      className="block"
                    >
                      <div
                        className={`flex ${
                      ...
                      >
                        <div
                          ...
                          } bg-gray-300 rounded-2xl mb-4 overflow-hidden flex-shrink-0`}
                        >
                          <img
                            src={
                              recipe.image_url ||
